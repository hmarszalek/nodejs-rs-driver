    ...
    describe("#onSuccess()", () => {
        context("when request is slow", () => {
            ...
            const loggerShortMessage = new RequestLogger({
                slowThreshold: 200,
                messageMaxQueryLength: 20,
                messageMaxParameterValueLength: 5,
            });
            ...
            it("should stringify individual object values", () => {
                ...
                helper.assertContains(
                    message,
                    `INSERT SAMPLE (k1, k2) VALUES (?, ?) [${params.join(",")}]`,
                );
            });
            ...
            it("should include size information and round to KB", () => {
                ...
                helper.assertContains(
                    message,
                    "request size 12 KB / response size 231 bytes",
                );
            });
            ...
            it("should include batch information and queries", () => {
                ...
                helper.assertContains(
                    message,
                    "request size 80 bytes / response size 231 bytes",
                );
                helper.assertContains(
                    message,
                    "BATCH w/ 2 not prepared queries (Q1 [],Q2 [a,b])",
                );
            });
            ...
            it("should include batch information and truncate queries info", () => {
                ...
                helper.assertContains(
                    message,
                    "BATCH w/ 3 not prepared queries (INSERT1 [],INSERT2 [...],...)",
                );
            });
            ...
            it("should truncate query in the message when query is too long", () => {
                ...
                assert.strictEqual(
                    message.indexOf("this_should_not_be_included"),
                    -1,
                );
            });
    ...
    describe("#onError()", () => {
        ...
        context("when request is large", () => {
            it("should include stack trace when large request failed", () => {
                ...
                helper.assertContains(
                    largeMessage,
                    "Request exceeded length and execution failed",
                );
